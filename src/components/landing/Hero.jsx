  ...
  return (
    <section className="relative overflow-hidden px-4 pb-20 pt-16 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="absolute left-1/2 top-1/3 h-[260px] w-[260px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl bg-[radial-gradient(circle,rgba(16,185,129,0.04)_0%,transparent_75%)]"
        />
